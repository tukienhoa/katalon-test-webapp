...
WebUI.setText(findTestObject('Object Repository/Renew password/Page_React App/input_Sign Up_email'), 'vinhtu0171@gmail.com')
...
WebUI.verifyEqual(AlertText, 'New password sent to your email.')
