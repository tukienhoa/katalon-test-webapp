...
WebUI.click(findTestObject('Object Repository/View grade structure/Page_React App/a_Intro2IT'))

WebUI.click(findTestObject('Object Repository/View grade structure/Page_React App/a_Grade Structure'))

WebUI.verifyElementNotPresent(findTestObject('Object Repository/View grade structure/Page_React App/div_Exercise 2Points 1'), 
    5)
