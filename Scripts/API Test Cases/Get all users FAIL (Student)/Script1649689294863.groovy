...
'Create body'
def stringBody = "{ \"username\": \"vinhtu\",	\"password\": \"mj2PAS\"}"
...
'Send request'
ResponseObject getResponse = WS.sendRequest(findTestObject('GetRequest/GetAllUsers - Jwt', [('jwt_token') : afterParsing.token]))
